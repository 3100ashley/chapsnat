...
import { Image, StyleSheet, Text, View, TouchableOpacity, Platform, Modal, TextInput } from "react-native";
    ...
    <View style={styles.container}>
      {user ? (
        <>
          <View style={styles.headerColumn}>
            ...
            <View style={styles.Row}>
              ...
              <TouchableOpacity onPress={() => {setModalVisible(true)}}>
                  <Ionicons name={"create-outline"} size={25} style={{marginBottom: 5, marginLeft: 3}} color={Colors.tabIconDefault}/>
              </TouchableOpacity>
            </View>
          ...
          <EditModal setModalVisible={setModalVisible}
          modalVisible={modalVisible}
          setDisplayName={setDisplayName}></EditModal>
        </>
      ) : (
        <View></View>
      )}
...
function EditModal(props) {
  ...
  const onPressSaveNewName = async () => {
    props.setModalVisible(!props.modalVisible); //props.
